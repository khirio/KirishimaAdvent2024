...
- VIm-V-VI-III進行（四段流し）
  - ジャズによく用いられる
  - `アメリカ`のイメージ？
  - 意外なところでは[「デビルマンのうた」](https://www.youtube.com/watch?v=ip_547kDQM8)のAメロもこのコード進行
- VIm-III-V-II-VI-I-IIm-III（雪崩クリシェ）
...
- ペンタトニックスケール
  ...
  - 長調の場合は`中華`音階
- 短調6度抜き
  - ペンタトニックスケールの制約を緩めたもの
  - ほとんどの東方原曲に登場
  - [「夜桜お七」](https://www.youtube.com/watch?v=f3cmggPaQMw)など、演歌でもよく使われている
...
- テクノ（YMO、増子司、古代祐三）
  ...
  - 「東方」としての処女作である[「東方怪奇談」](https://www.youtube.com/watch?v=c-2v7Q7qCd0&pp=ygUP5p2x5pa55oCq5aWH6KuH)には、YMOの[「RYDEEN」](https://www.youtube.com/watch?v=nB5g2cUM2FQ)ががっつり引用されています。
...
東方っぽい、といえば、まずこの人たちは外せません。
コンフィデンスマンJPや、最近だと[実写版「推しの子」](https://music.amazon.co.jp/albums/B0DMWBX476?ref=dm_sh_2e24-fb08-45b2-51cb-31641)の劇伴を担当してたりします。
ピアノ、ベース、ヴァイオリン、ドラムを基本とする、テンポの速い曲が特徴のインストバンドです。
TVから東方めいたフレーズが流れてくるの新鮮。

### 3-2. jizue

fox capture planとかなり似た作風ですが、ヴァイオリンがあまり出てこなかったり、三拍子の曲が多いことが特徴です。
...
普段から東方っぽい曲は出していないアーティストについても、東方っぽい曲があり**ましたので**（ルメール弁）いくつか紹介していきます。

### 4-1. Pia-no-jaC
ピアノとカホン（手で叩いて音を出す箱型の打楽器）の2ピースバンドです。
やたらパワフルなピアノさばきが特徴。ピアノは打楽器、（発音原理上は）何も間違ってない。
読み方「ピアノジャク」で「天邪鬼」とかけている所も東方ポイント高め。
...
私たちが作品を通して見ている幻想郷は、現実でも夢でもなく、あくまでも「投影」されたイメージに過ぎない。ゆえに東方原作も、幻想郷を原点として翻案された「二次創作」である、と。
...
おすすめ曲のプレイリスト（自動で作成されるやつ）に東方っぽい曲がメッチャ出てくるようになって、QOLが上がります。
